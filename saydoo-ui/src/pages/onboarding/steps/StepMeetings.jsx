export default function StepMeetings({ data, setData }) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-6 md:p-8 shadow-sm text-black">
      <h2 className="text-2xl md:text-3xl font-bold text-gray-800">Meetings & Next Steps</h2>
      <p className="mt-2 text-gray-500 text-sm">How founders can request meetings and follow-ups</p>

      <div className="mt-6">
        <label className="flex items-center gap-3">
          <input type="checkbox" checked={meetings.allowMeetings!==false} onChange={(e)=>update('allowMeetings', e.target.checked)} />
          <span className="text-sm text-gray-700">Allow founders to request meetings</span>
        </label>
      </div>
